...
if __name__ == "__main__":
    ...
    univ3 = sg.load_subgraph(
        f"https://gateway.thegraph.com/api/{api_key}/subgraphs/id/ELUcwgpm14LKPLrBRuVvPvNKHQ9HvwmtKgKSH6123cr7"
    )
    balv2 = sg.load_subgraph(
        f"https://gateway.thegraph.com/api/{api_key}/subgraphs/id/Ei5typKWPepPSgqkaKf3p5bPhgJesnu1RuRpyt69Pcrx"
    )
